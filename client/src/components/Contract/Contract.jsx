...
import contractInfo from "contracts/contractInfo2.json";
...
export default function Contract() {
  ...
  const contractAddress = useMemo(
    () => "0x8440b841d8526dfF453aFeCD609b447f160c8652",
    []
  );

  /**Live query */
  const { data } = useMoralisQuery("AudioSavedEvents", (query) => query, [], {
    live: true,
  });
